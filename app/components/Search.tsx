...
import { useGetGames } from "@/lip/queryFunctions";
    ...
    >
      ...
      <AnimatePresence>
        {(games?.data || isLoading) && active && (
          <MotionItem className="absolute w-full top-full z-50 bg-[#222425] rounded-2xl shadow-sm max-h-[40vh] overflow-y-scroll left-0">
            {isLoading ? (
